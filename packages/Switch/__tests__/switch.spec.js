...
import vSwitch from '../index.vue' // 请根据你的文件路径修改
...
describe('vSwitch', () => {
  it('renders a switch with the correct initial state', () => {
    ...
    // 断言开关是否渲染正确的初始状态
    expect(wrapper.find('.v-switch_content').attributes('style')).toContain(
  ...
  it('toggles the switch on click', async () => {
    ...
    // 模拟点击开关
    const switchContent = wrapper.find('.v-switch_content')
