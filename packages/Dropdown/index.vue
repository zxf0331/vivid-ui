<template>
  <div class="v-dropdown">
    ...
    <transition name="slide-fade">
      <div class="v-dropdown-list" v-show="isShow" @mouseleave="isShow = false">
        <div class="v-dropdown-all">
          <template v-for="(item, index) in options" :key="index">
            <div class="item">
              <slot>
                <i :class="item.icon"></i>
              </slot>
              <div class="v-dropdown-list-item" @click="change(item, index)">{{ item.label }}</div>
            </div>
          </template>
        </div>
      </div>
